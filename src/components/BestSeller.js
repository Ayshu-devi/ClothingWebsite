...
const Category = () => {
  ...
  return (
    <div className="bg-white mt-16 text-center">
      <Heading
        title="Best Seller"
        description="Discover the latest trends and timeless styles in fashion. Our clothing collection is curated to offer you the best in quality, comfort, and design."
      />
